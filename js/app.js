    ...
    (() => {
        ...
        let _slideUp = (target, duration = 500, showmore = 0) => {
            if (!target.classList.contains("_slide")) {
                ...
                target.style.transitionProperty = "height, min-height, margin, padding";
                ...
                window.setTimeout((() => {
                    ...
                    !showmore ? target.style.removeProperty("min-height") : null;
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu") || document.querySelector("('.main-footer__menu .menu__button')")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && (e.target.closest(".icon-menu") || e.target.closest(".main-footer__menu .menu__button"))) {
                    bodyLockToggle();
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if ("items" === showMoreType) {
                        ...
                        const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 1e-4;
        ...
        const selectors = document.querySelectorAll(".form__input_tel .input");
        if (selectors.length) for (let i = 0; i < selectors.length; i++) {
            let im = new Inputmask("+7 9 9 9 - 9 9 9 - 9 9 - 9 9");
            im.mask(selectors[i]);
        }
        ...
        function initSliders() {
            if (document.querySelector(".schedule-add__slider")) new core(".schedule-add__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 7,
            ...
            if (document.querySelector(".video-gallery__slider")) new core(".video-gallery__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            let foodSlider;
            if (document.querySelector(".images-food__slider")) foodSlider = new core(".images-food__slider", {
            ...
            if (document.querySelector(".last-news__slider")) new core(".last-news__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".last-news__button_prev",
                    nextEl: ".last-news__button_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".certificate__slider")) new core(".certificate__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".certificate__button_prev",
                    nextEl: ".certificate__button_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
                ...
                navigation: {
                    prevEl: ".reviews__navigation-button_prev",
                    nextEl: ".reviews__navigation-button_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".team__slider")) new core(".team__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".team__navigation-button_prev",
                    nextEl: ".team__navigation-button_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".main-page__slider")) new core(".main-page__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".main-page__button_prev",
                    nextEl: ".main-page__button_next"
                },
                on: {}
            });
        }
